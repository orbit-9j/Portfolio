export default [
  {
    ...
    description:
      "A responsive website made with React JS (+ react Router DOM) and styled using Sass (paused 09/08/2022)",
  ...
  },
  {
    ...
    description:
      "A responsive HTML website using Javascript and styled using Sass (completed 17/07/2022)",
  ...
  },
  {
    ...
    description:
      "A responsive HTML website made with React JS (+ react Router DOM) and styled using Sass (ongoing)",
...

  {
    ...
    description:
      "A pseudo-responsive website using CSS & HTML about the history and uses of wireless communication, made for Web Applications coursework 1. Scored 10/10 in assessment (completed 11/2020)",
